        ...
        <div class="card card-<?php echo get_option('accent_color') ?> card-outline">
          <div class="card-header">
              <div class="card-title">
                <a href="<?php echo base_url('administrator/blog/add'); ?>" class="btn btn-sm btn-<?php echo get_option('accent_color') ?>"><i class="fas fa-plus"></i> Add New</a>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu" style="">
                      <a class="dropdown-item" href="<?php echo base_url('administrator/blog/export_pdf'); ?>">PDF</a>
                      <a class="dropdown-item" href="<?php echo base_url('administrator/blog/export_excel'); ?>">Excel</a>
                    </div>
                  </div>
              </div>
            ...
            <table class="table table-striped">
              <thead>
                  <tr>
                      ...
                      <th width="100" style="text-align:center;">Published</th>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu" style="">
                            <a class="dropdown-item" href="<?php echo base_url('administrator/blog/edit/' . wah_encode($row->id)); ?>">Edit</a>
                            <a class="dropdown-item" data-toggle="confirmation" data-title="Are you sure want to delete?"  data-placement="left" href="<?php echo base_url('administrator/blog/delete/' . wah_encode($row->id)); ?>">Delete</a>
                          </div>
                        </div>
                      </td>
                  </tr>
